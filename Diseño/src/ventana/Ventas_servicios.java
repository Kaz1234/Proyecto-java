 ...
 * @author usuari
 */
public class Ventas_servicios extends javax.swing.JFrame {

    /**
     * Creates new form Ventas_servicios
     */
    ...
    private void initComponents() {
        ...
        titulo.setText("VENTA DE SERVICIOS");
        getContentPane().add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 110, -1, -1));
        ...
        getContentPane().add(jRetorno, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 480, -1, -1));
        ...
        getContentPane().add(accion, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 430, -1, -1));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/165961.jpg"))); // NOI18N
        getContentPane().add(fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 846, 531));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventas_servicios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventas_servicios().setVisible(true);
            }
        });
    }
